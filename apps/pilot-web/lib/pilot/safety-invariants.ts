...
export const SAFETY_INVARIANTS_VERSION = "12.14.0";
...
export const SAFETY_INVARIANTS: readonly SafetyInvariant[] = [
  ...
  { id: "unverifiable-transcript-needs-confirmation", description: "A transcript from an English-only model that the caller did not explicitly request in English is never status 'ok' — it cannot be verified, however fluent it reads.", machineCheckable: true, severity: "critical" },
