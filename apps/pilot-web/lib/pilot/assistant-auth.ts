// MigraPilot — embeddable assistant bearer-secret auth (P1).
//
...
export function checkAssistantAuthForEnv(req: Request, envVarName: string): { ok: boolean } {
...
export function checkAssistantAuth(req: Request): { ok: boolean } {
  return checkAssistantAuthForEnv(req, "MIGRAPILOT_ASSISTANT_SECRET");
}
