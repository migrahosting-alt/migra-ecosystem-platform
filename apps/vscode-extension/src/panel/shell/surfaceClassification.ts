...
export const SURFACES: readonly SurfaceRecord[] = [
  ...
  { id: 'migrapilot.requestTimeoutMs', kind: 'setting', label: 'Stream patience', cls: 'internal-diagnostics', why: 'How long to wait without progress; tuning, not a coding decision.' },
  { id: 'migrapilot.brainTimeoutMs', kind: 'setting', label: 'Request ceiling', cls: 'internal-diagnostics', why: 'Hard ceiling for one non-streaming request; tuning, but it must at least be DECLARED — it governed Explain and Fix while being invisible.' },
  { id: 'migrapilot.brainConnectionTimeoutMs', kind: 'setting', label: 'Health probe timeout', cls: 'internal-diagnostics', why: 'Reachability probe tuning.' },
