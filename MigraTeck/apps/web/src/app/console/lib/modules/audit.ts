...
export const describeAction = (action: string): string => {
  const map: Record<string, string> = {
    ...
    "domain.active": "Activated domain",
    "domain.suspended": "Suspended domain",
    "domain.autorenew_on": "Enabled domain auto-renew",
    "domain.autorenew_off": "Disabled domain auto-renew",
    "order.add": "Added product order",
    "order.payment_link_pending": "Queued payment request",
    "order.payment_link_sent": "Sent payment link",
    "mailbox.active": "Activated mailbox",
    "mailbox.suspended": "Suspended mailbox",
    "mailbox.disabled": "Disabled mailbox",
