 ...
 * implementation, every caller now fails loudly until the website-scoped commands are
 * defined in the operation contract and can target a real service instance.
 */
